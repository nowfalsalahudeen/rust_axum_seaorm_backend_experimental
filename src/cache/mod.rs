...
impl Cache {
  ...
  /// ```
  ///
  /// use pos_rust_local_backend::cache;
  /// use pos_rust_local_backend::cache::CacheResult;
  ///
  ...
  ///  ///
  ///
  /// use pos_rust_local_backend::config::app_context::get_app_context;
  ///
  ...
  pub async fn get_or_insert<F>(&self, key: &str, f: F) -> Result<String>
  where
